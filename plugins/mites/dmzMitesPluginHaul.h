#ifndef DMZ_MITES_PLUGIN_HAUL_DOT_H
#define DMZ_MITES_PLUGIN_HAUL_DOT_H
...
namespace dmz {
   ...
   class MitesPluginHaul :
         public Plugin,
         public TimeSlice,
         public ObjectObserverUtil {

      public:
         MitesPluginHaul (const PluginInfo &Info, Config &local);
         ~MitesPluginHaul ();
      ...
      private:
         MitesPluginHaul ();
         MitesPluginHaul (const MitesPluginHaul &);
         MitesPluginHaul &operator= (const MitesPluginHaul &);

   };
};

#endif // DMZ_MITES_PLUGIN_HAUL_DOT_H
