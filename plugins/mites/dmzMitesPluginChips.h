#ifndef DMZ_MITES_PLUGIN_CHIPS_DOT_H
#define DMZ_MITES_PLUGIN_CHIPS_DOT_H
...
namespace dmz {
   ...
   class MitesPluginChips :
         public Plugin,
         public TimeSlice,
         public ObjectObserverUtil {

      public:
         MitesPluginChips (const PluginInfo &Info, Config &local);
         ~MitesPluginChips ();
      ...
      private:
         MitesPluginChips ();
         MitesPluginChips (const MitesPluginChips &);
         MitesPluginChips &operator= (const MitesPluginChips &);

   };
};

#endif // DMZ_MITES_PLUGIN_CHIPS_DOT_H
